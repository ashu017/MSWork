param (
    [string] $databaseName,
    [string] $server ,
   # [string] $sqlServerDnsName ,
    [string] $location
)

# $databaseName = "db-pipelinemanager-test22-northeurope"
# $server = "sql-pipelinemanager-test22-northeurope-primary"
# $location = "northeurope"


Write-Output "Env variables: Location=$location;"
